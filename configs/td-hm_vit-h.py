...
# codec settings
codec = dict(
    type='UDPHeatmap', input_size=(800, 800), heatmap_size=(200, 200), sigma=2)
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint='/mnt/guodongqian/CL-Detection2023-MMPose/mae_pretrain_vit_huge_20230913.pth'),
    ),
    head=dict(
        type='HeatmapHead',
        in_channels=1280,
...
data_mode = 'topdown'
# data_root = '/mnt/guodongqian/diffusers/examples/controlnet/'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode='topdown',
        ann_file='/mnt/guodongqian/CL-Detection2023-MMPose/generate_condition/annotations/train.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode='topdown',
        ann_file='/mnt/guodongqian/CL-Detection2023-MMPose/generate_condition/annotations/val.json',
        data_prefix=dict(img='MMPose/'),
        test_mode=True,
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_mode='topdown',
        ann_file='/mnt/guodongqian/CL-Detection2023-MMPose/generate_condition/annotations/test.json',
